...
<section class="mt-16 pb-24">
	...
	<div class="mx-auto mt-8 flex w-full max-w-6xl flex-col gap-10 px-6 md:flex-row md:justify-between">
		...
		<div class="w-full md:w-[39%]">
			...
			<p>
				Tu fais partie d'une fanfare et tu veux postuler pour la prochaine édition ? Ou tu es
				plutôt du genre à donner un coup de main et tu veux devenir bénévole pour participer à
				cette fête pendant tout un week-end ? Dans tous les cas, on a hâte de te lire ! Laisse-nous
				un message avec quelques infos sur toi (ou votre fanfare) et on revient vers toi rapidement
				pour la suite.
			</p>
		</div>
	</div>
